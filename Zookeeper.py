...
# Declaring variables with animal art
camel = r"""
...
# Insert animals on an array
zoo = [camel,lion,deer,goose,bat,rabbit]
# Loop bool for selecting input + array pop print / options for user
while True:
   choicehab = input("Which habitat # do you need?" " " "write 'exit' if you need to leave the watcher>")
   # If the input is different to exit, will print the selected input
   if choicehab != 'exit':
      print(zoo[int(choicehab)])
   #Else it will break the loop and print end message
   else:
      break 
print('See you!')